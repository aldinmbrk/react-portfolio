  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-2 md:py-10">
        <NavLink to="/">
          <span className="text-2xl bg-gradient bg-clip-text text-transparent font-bold">
            aldinmbrk
          </span>
        </NavLink>
            ...
            <a href={instagram} target="_blank" rel="noreferrer noopener">
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M15 2.703c4.005 0 4.48.015 6.06.087 3.616.165 5.302 1.875 5.467 5.466.072 1.582.087 2.056.087 6.062 0 4.005-.015 4.479-.087 6.06-.165 3.585-1.849 5.302-5.467 5.467-1.58.072-2.055.087-6.06.087-4.006 0-4.48-.015-6.063-.087-3.616-.165-5.301-1.876-5.466-5.467-.072-1.58-.087-2.055-.087-6.06 0-4.006.015-4.48.087-6.063.165-3.584 1.849-5.301 5.466-5.466 1.583-.072 2.057-.087 6.063-.087M15 0C10.926 0 10.416.017 8.816.09 3.37.338.337 3.366.09 8.816.017 10.416 0 10.926 0 15c0 4.074.017 4.584.09 6.184.247 5.445 3.275 8.478 8.726 8.726 1.6.073 2.11.09 6.184.09 4.074 0 4.584-.017 6.184-.09 5.446-.247 8.478-3.276 8.726-8.726.073-1.6.09-2.11.09-6.184 0-4.074-.017-4.584-.09-6.184-.247-5.446-3.276-8.479-8.726-8.726C19.584.017 19.074 0 15 0zm0 7.297a7.703 7.703 0 100 15.406 7.703 7.703 0 000-15.406zm0 12.703a5 5 0 110-10 5 5 0 010 10zm8.008-13.716a1.8 1.8 0 100 3.6 1.8 1.8 0 000-3.6z"
                />
              </svg>
            </a>
          </li>
